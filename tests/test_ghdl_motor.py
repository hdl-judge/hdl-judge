...
def test_ghdl_motor():
    ...
    files = [
        File(filename="adder.vhdl", content="""entity adder is
    ...
    begin
      ...
      co <= (i0 and i1) or (i0 and ci) or (i1 and ci);
        ...
        File(filename="adder_tb.vhdl", content="""--  A testbench has no ports.
            entity adder_tb is
            end adder_tb;
    ...
    submission_return = motor.get_waveform("adder", files)

    assert submission_return.result == """$version
  GHDL v0
$end
$timescale
  1 fs
